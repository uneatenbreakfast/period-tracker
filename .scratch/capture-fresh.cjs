...
(async () => {
  ...
  const page = await browser.newPage({ viewport: { width: 540, height: 1320 }, deviceScaleFactor: 1 });
  ...
  await page.screenshot({ path: '/mnt/c/Repos/period-tracker-worktrees/17869649/.scratch/exp-fresh.png' });
  console.log('saved exp-fresh.png', (await page.evaluate(() => document.body.scrollHeight)));
  await browser.close();
