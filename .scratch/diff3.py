...
exp = Image.open('/home/nelsonw/.hermes/cache/images/img_32ddf3f14a98.png').convert('RGB')
ra = np.array(ref.resize((540, 1320)))  # exports come out same size; resize harmless
