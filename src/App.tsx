...
export default function App() {
  ...
  /** Drag on the calendar: log the whole dragged span as period days. */
  const logFlowRange = (from: string, to: string) => {
    setSnap((s) => applyFlowRange(s, from, to, 'medium'))
  }
