...
export default function Calendar({
  ...
  return (
    <div className="rounded-3xl bg-white p-5 shadow-[0_6px_24px_rgba(217,111,147,0.12)]">
      <div className="mb-3 grid grid-cols-7 text-center text-[11px] font-bold uppercase tracking-wider text-ink-soft">
      ...
      {!prediction || (prediction.fertileWindow === null && predictedDays.length === 0) ? null : (
